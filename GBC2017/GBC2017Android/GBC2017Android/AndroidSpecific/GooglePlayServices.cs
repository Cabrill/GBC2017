...
namespace GBC2017.AndroidSpecific
{
    using System;
    ...
    namespace GooglePlay.Services.Helpers
    {
        ...
        /// </summary>
        public class GooglePlayServices : Java.Lang.Object, GoogleApiClient.IConnectionCallbacks, GoogleApiClient.IOnConnectionFailedListener
        {
            #region Singleton

            public static GooglePlayServices Instance { get; } = new GooglePlayServices();
            ...
            public void Initialize(Activity activity, View viewforPopups)
            {
                this.activity = activity;
                ViewForPopups = viewforPopups;
